											...
											<div class="row">
												<div class="col-xl-12 col-lg-12 col-md-12 d-block mx-auto">
													...
													<div class="text-center background-text">
														<a href="#" class="btn btn-warning pl-6 pr-6 pt-2 pb-2 mx-auto float-left mt-5">EXCHANGE NOW</a>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="row row-sm">
										...
										<div class="card custom-card crypto-card overflow-hidden">
											<div class="card-body pb-0">
												<div class="mb-0 d-flex">
													<h5 class="d-flex mb-0"><span class="cryp-icon bg-primary my-auto mr-2 mt-1"><i class="cf cf-btc"></i></span>Bitcoin BTC</h5>
													<span class="float-right ml-auto btn btn-success btn-sm">24h</span>
												</div>
												<div class="d-flex justify-content-between mt-2">
													<h5 class="d-flex my-auto font-weight-normal">0.00000434<span class="text-info tx-14 mt-auto ml-2">$0.04</span> </h5>
									...
									<div class="col-xl-4 col-md-12 col-lg-6">
										<div class="card custom-card crypto-card overflow-hidden">
											<div class="card-body pb-0">
												<div class="mb-0 d-flex">
													<h5 class="d-flex mb-0"><span class="cryp-icon bg-primary my-auto mr-2 mt-1"><i class="cf cf-eth"></i></span> Ethereum ETH</h5>
													<span class="float-right ml-auto btn btn-success btn-sm">24h</span>
												</div>
												<div class="d-flex justify-content-between mt-2">
													<h5 class="d-flex my-auto font-weight-normal">0.00000235<span class="text-info tx-14 mt-auto ml-2">$0.12</span> </h5>
									...
									<div class="col-xl-4 col-md-12 col-lg-6">
										<div class="card custom-card crypto-card overflow-hidden">
											<div class="card-body pb-0">
												<div class="mb-0 d-flex">
													<h5 class="d-flex mb-0"><span class="cryp-icon bg-primary my-auto mr-2 mt-1"><i class="cf cf-xrp"></i></span> Ripple  XRP</h5>
													<span class="float-right ml-auto btn btn-success btn-sm">24h</span>
												</div>
												<div class="d-flex justify-content-between mt-2">
													<h5 class="d-flex my-auto font-weight-normal">0.00000434<span class="text-info tx-14 mt-auto ml-2">$0.03</span> </h5>
									...
									<div class="col-xl-4 col-md-12 col-lg-6">
										<div class="card custom-card crypto-card overflow-hidden">
											<div class="card-body pb-0">
												<div class="mb-0 d-flex">
													<h5 class="d-flex mb-0"><span class="cryp-icon bg-primary my-auto mr-2 mt-1"><i class="cf cf-dash"></i></span>Dash  DASH</h5>
													<span class="float-right ml-auto btn btn-success btn-sm">24h</span>
												</div>
												<div class="d-flex justify-content-between mt-2">
													<h5 class="d-flex my-auto font-weight-normal">0.00000372<span class="text-info tx-14 mt-auto ml-2">$0.12</span> </h5>
									...
									<div class="col-xl-4 col-md-12 col-lg-6">
										<div class="card custom-card crypto-card overflow-hidden">
											<div class="card-body pb-0">
												<div class="mb-0 d-flex">
													<h5 class="d-flex mb-0"><span class="cryp-icon bg-primary my-auto mr-2 mt-1"><i class="cf cf-neos"></i></span> Neo NEO</h5>
													<span class="float-right ml-auto btn btn-success btn-sm">24h</span>
												</div>
												<div class="d-flex justify-content-between mt-2">
													<h5 class="d-flex my-auto font-weight-normal">0.00000257<span class="text-info tx-14 mt-auto ml-2">$0.07</span> </h5>
									...
									<div class="col-xl-4 col-md-12 col-lg-6">
										<div class="card custom-card crypto-card overflow-hidden">
											<div class="card-body pb-0">
												<div class="mb-0 d-flex">
													<h5 class="d-flex mb-0"><span class="cryp-icon bg-primary my-auto mr-2 mt-1"><i class="cf cf-ltc"></i></span> Litecoin LTC</h5>
													<span class="float-right ml-auto btn btn-success btn-sm">24h</span>
												</div>
												<div class="d-flex justify-content-between mt-2">
													<h5 class="d-flex my-auto font-weight-normal">0.00000534<span class="text-info tx-14 mt-auto ml-2">$0.32</span> </h5>
													<div class="text-danger"><i class="mr-1 text-success"></i> +2.12%</div>
												</div>
												<div class="chart-wrapper mt-4">

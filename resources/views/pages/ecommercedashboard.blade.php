									...
									<div class="card-body">
										<ul class="visitor mb-0 d-block users-images list-unstyled list-unstyled-border">
											<li class="media d-flex mb-3 mt-0 pt-0">
												<img class="mr-3 rounded-circle avatar avatar-md" src="{{URL::asset('assets/img/users/3.jpg')}}" alt="avatar">
											...
											<li class="media d-flex mb-3">
												<img class="mr-3 rounded-circle avatar avatar-md" src="{{URL::asset('assets/img/users/5.jpg')}}" alt="avatar">
												<div class="media-body mb-1">
											...
											<li class="media d-flex mb-3">
												<img class="mr-3 rounded-circle avatar avatar-md" src="{{URL::asset('assets/img/users/7.jpg')}}" alt="avatar">
												<div class="media-body mb-1">
											...
											<li class="media d-flex mb-3">
												<img class="mr-3 rounded-circle avatar avatar-md" src="{{URL::asset('assets/img/users/4.jpg')}}" alt="avatar">
												<div class="media-body mb-1">
											...
											<li class="media d-flex mb-0">
												<img class="mr-3 rounded-circle avatar avatar-md" src="{{URL::asset('assets/img/users/9.jpg')}}" alt="avatar">
												<div class="media-body mb-1">
													<div class="float-right"><small>19-9-2018</small></div>
													<h5 class="media-title tx-15 mb-0">Anthony</h5>
													<small class="text-muted">sed do eiusmod </small>
										...
										<div class="table-responsive">
											<table class="table table-vcenter border mb-0 text-nowrap">
												...
												<tbody>
													<tr>
														<td>#C234</td>
														<td class="d-flex my-auto"><img src="{{URL::asset('assets/img/pngs/14.png')}}" alt="" class="ht-40 wd-40 mr-3"><span class="my-auto">Regular waterproof (24 L) Backpack</span></td>
														<td><b>$14,500</b></td>
														<td>2,977</td>
													...
													<tr>
														<td>#C389</td>
														<td class="d-flex my-auto"><img src="{{URL::asset('assets/img/pngs/15.png')}}" alt="" class="ht-40 wd-40 mr-3"><span class="my-auto">Women Pink Heels Sandal</span></td>
														<td><b>$30,000</b></td>
														<td>678</td>
													...
													<tr>
														<td>#C936</td>
														<td class="d-flex my-auto"><img src="{{URL::asset('assets/img/pngs/16.png')}}" alt="" class="ht-40 wd-40 mr-3"><span class="my-auto">Designer Hand Decorative flower Pot</span></td>
														<td><b>$13,200</b></td>
														<td>4,922</td>
													...
													<tr>
														<td>#C493</td>
														<td class="d-flex my-auto"><img src="{{URL::asset('assets/img/pngs/17.png')}}" alt="" class="ht-40 wd-40 mr-3"><span class="my-auto">Plastic Outdoor Chair</span></td>
														<td><b>$15,100</b></td>
														<td>1,234</td>
														<td><span class="badge badge-primary">Limited</span></td>
													</tr>
													<tr>
														<td>#C729</td>
														<td class="d-flex my-auto"><img src="{{URL::asset('assets/img/pngs/18.png')}}" alt="" class="ht-40 wd-40 mr-3"><span class="my-auto">Blck Digital smart watch</span></td>
														<td><b>$5,987</b></td>
														<td>4,789</td>
													...
													<tr>
														<td>#C529</td>
														<td class="d-flex my-auto"><img src="{{URL::asset('assets/img/pngs/19.png')}}" alt="" class="ht-40 wd-40 mr-3"><span class="my-auto">Apple iPhone(Black, 128 GB)</span></td>
														<td><b>$11,987</b></td>
														<td>938</td>
														<td><span class="badge badge-primary">Limited</span></td>
													</tr>

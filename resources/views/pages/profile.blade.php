															...
															<div class="col-12">
																<div class="card mg-b-20 border">
																	...
																	<div class="card-body">
																		...
																		<div class="row row-sm">
																			<div class="col"> <img alt="img" class="wd-200 mr-4" src="{{URL::asset('assets/img/media/1.jpg')}}"> <img alt="img" class="wd-200" src="{{URL::asset('assets/img/media/2.jpg')}}"> </div>
																		</div>
																...
																<div class="card mg-b-20 border">
																	...
																	<div class="card-body h-100">
																		<p class="mg-t-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
																		<div class="row row-sm">
																			<div class="col"> <img alt="img" class="wd-200 mr-4" src="{{URL::asset('assets/img/media/4.jpg')}}"> <img alt="img" class="wd-200" src="{{URL::asset('assets/img/media/5.jpg')}}"> </div>
																		</div>
																		<div class="media mg-t-15 profile-footer">
																			<div class="media-user mr-2">
																				<div class="demo-avatar-group">
																...
																<div class="card border">
																	...
																	<div class="card-body h-100">
																		<p class="mg-t-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
																		<div class="row row-sm">
																			<div class="col"> <img alt="img" class="wd-200 mr-3" src="{{URL::asset('assets/img/media/4.jpg')}}"> <img alt="img" class="wd-200" src="{{URL::asset('assets/img/media/7.jpg')}}"> </div>
																		</div>
																		<div class="media mg-t-15 profile-footer">
																			<div class="media-user mr-2">
																				<div class="demo-avatar-group">

													...
													<div id="checkoutsteps">
														...
														<section>
															<form class="needs-validation" novalidate="">
																<h5 class="text-left mb-2">Billing Information</h5>
																<p class="mb-4 text-muted tx-13 ml-0 text-left">Lorem Ipsum has been the industry's standard dummy text ever since</p>
																<div class="row">
														...
														<h4>Order</h4>
														<section>
															<h5 class="text-left mb-2">Your Order</h5>
															<p class="mb-4 text-muted tx-13 ml-0 text-left">Lorem Ipsum has been the industry's standard dummy text ever since</p>
															<div class="product">
																<div class="item">

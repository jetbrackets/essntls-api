													...
													<ul class="list-group">
														...
														<li>Cras justo odio
															<ul class="list-group checked">
															  <li class="list-group-item"><i class="fe fe-check mr-3 tx-13" aria-hidden="true"></i>Lorem </li>
															  <li class="list-group-item"><i class="fe fe-check mr-3 tx-13" aria-hidden="true"></i>established</li>
															  <li class="list-group-item"><i class="fe fe-check mr-3 tx-13" aria-hidden="true"></i>Contrary</li>
															</ul>
														</li>
														<li>Porta ac consectetur ac</li>
														<li>Vestibulum at eros</li>

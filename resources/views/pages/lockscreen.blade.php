								...
								<div class="container-fluid">
									<div class="row row-sm">
										<div class="card-body main-profile-overview mt-3 mb-3">
											...
											<p class="mb-4 text-muted tx-13 ml-0 text-left">Unlock your screen by entering password</p>
											<form action="{{url('index')}}">
												<div class="text-left d-flex float-left mb-4 user-lock">
													...
													<div class="my-auto">
														<p class="font-weight-semibold my-auto ml-2 text-uppercase ">Sonia Taylor</p>
													</div>
												</div>
